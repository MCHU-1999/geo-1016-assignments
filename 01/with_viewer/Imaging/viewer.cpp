...
void ImagingViewer::init() {
    Viewer::init();
    key_press_event(GLFW_KEY_SPACE, 0);
}
...
std::string ImagingViewer::usage() const {
    return ("\n============================== Usage ====================================\n"
            ...
            "\t\t- Wheel: zoom in/out                                                 \n"
            "-------------------------------------------------------------------------\n"
            "\t Press the space' key to restore the camera view.                      \n"
            "\t Check file 'imaging.cpp' to see how the 3D points are projected.      \n"
            "-------------------------------------------------------------------------\n");
}
